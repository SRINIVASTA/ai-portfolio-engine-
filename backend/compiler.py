...
def auto_generate_portfolio_index(username, ml_sorted_repos): 
    ...
    # 🎯 UPDATED: Use an adaptive dictionary tracking layout instead of static variables
    dynamic_tracks = {} 
    unassigned_html = "" 
    for repo in ml_sorted_repos: 
        ...
        # 🎯 UPDATED: Safely load unsupervised title values generated by your new ml_processor
        ...
        # ========================================================================= 
        # 3. DYNAMIC REPOSITORY ROUTING VIA ML-GENERATED TAGS
        # ========================================================================= 
        if "core_foundation" in tag or name.lower() == "resume": 
            ...
            <a href="https://github.com{clean_user}/{name}" target="_blank" style="background:rgba(33,38,45,0.4); border:1px solid #30363d; padding:14px; border-radius:10px; text-decoration:none; display:block;"> 
                ...
                <div style="color:{lang_color}; font-size:10px; margin-top:4px; font-family:monospace;">🎛️ {lang} Matrix Node</div> 
            </a> 
            """ 
        else: 
